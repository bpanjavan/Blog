Running BlogEngine.NET 1.4.5 using MySQL 5:

If you wish to use MySQL to store all your blog data, this folder has all the 
information you'll likely need.  The scripts included here are for MySQL 5.
...
included is an upgrade script for users of BlogEngine 1.4.0.0.  In addition, you 
